...
RUN apk --update add --no-cache openssh zsh htop iftop git curl vim \
...
# RUN bash -c "$(curl -fsSL https://raw.githubusercontent.com/robbyrussell/oh-my-zsh/master/tools/install.sh)"  | zsh || true
